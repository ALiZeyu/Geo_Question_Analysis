...
public class ZhiShiSolution {

	public static String findFirst(Tree word, ArrayList<String> sentence) {
		Tree t = word.parent.parent;
		while (t.parent != null && 
				!((t.parent.content.equals("IP") || 
				   t.parent.content.equals("NP") || 
				   (t.parent.content.equals("VP") && t.parent.parent.content.equals("ROOT") && !t.parent.child.get(0).equals("ADVP"))) 
						&& t.parent.child.size() > 1 && t.parent.child.indexOf(t) > 0)) t = t.parent;
		...
		} else if (t.parent.child.get(t.parent.child.indexOf(t) - 1).content.equals("PP")) {
		...
		//这个是为了补全漏掉的顿号及之前的名词，不过现在应该是用不到了。
//		int i = 0;
